  ...
  template: `
    <svg [attr.width]="size" [attr.height]="size" viewBox="0 0 24 24"
      ...
      @switch (name) {
        ...
        @case ('eye-off') { <path d="M9.9 5.2A9.5 9.5 0 0 1 12 5c6.5 0 10 7 10 7a17.6 17.6 0 0 1-3.3 4.1M6.1 6.1A17.6 17.6 0 0 0 2 12s3.5 7 10 7a9.5 9.5 0 0 0 3.9-.8"/><path d="M9.9 9.9a3 3 0 0 0 4.2 4.2"/><line x1="3" y1="3" x2="21" y2="21"/> }
