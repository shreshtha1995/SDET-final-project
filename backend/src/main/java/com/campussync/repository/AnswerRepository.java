...
public interface AnswerRepository extends JpaRepository<Answer, Long> {
  ...
  @Query("SELECT a FROM Answer a JOIN FETCH a.answeredBy JOIN FETCH a.doubt WHERE a.answeredBy.id = :userId ORDER BY a.createdAt ASC")
    List<Answer> findByAnsweredById(@Param("userId") Long userId);
}
